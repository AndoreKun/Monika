...
namespace ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Monika\data\data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\AndyP\AppData\Local\Temp\MLVSTools\ML\ML.Model\MLModel.zip";
